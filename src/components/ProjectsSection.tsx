  ...
  return (
    ...
    >
      ...
      <div className="max-w-5xl mx-auto">
        ...
        {/* Projects with improved stacking effect */}
        <div 
          ref={containerRef}
          className="relative h-[400vh] pb-[50vh] mt-16" 
        >
          {projects.map((project, index) => {
            // Improved timing and smoothness
            const yRange = [
              index * 0.1, 
              index * 0.1 + 0.15
            ]; 
            ...
            const scaleRange = [1, 0.97];
            
            // Transform values with smoother transitions
            ...
            // Improved spring physics for smoother animation
            ...
            return (
              ...
              >
                <motion.div
                  className="grid grid-cols-1 md:grid-cols-12 gap-6 pointer-events-auto max-w-6xl mx-auto"
                    ...
                    >
                      ...
                      <div className="relative z-1">
                        ...
                        <p className="text-sm mb-4 text-gray-400">
                          Photography & Filmmaking Studio based in London
                        </p>
                        ...
                        <p className="text-gray-400 mb-6 flex-grow line-clamp-3">{project.description}</p>
