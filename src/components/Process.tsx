...
// Add JSON-LD schema for process
const processSchema = {
...
export default function Process() {
  ...
  const processSteps = [
    ...
    },
    {
      ...
      description: "Before jumping into visuals, we create wireframes to map out the structure and user flow. This ensures an intuitive and seamless experience for visitors."
    },
    {
      number: "3",
      title: "Visual Design & Branding",
      description: "This is where your website comes to life. Using your brand identity, we design a visually compelling interface with the perfect balance of aesthetics and usability."
    },
    {
      number: "4",
      title: "Development & Implementation",
      description: "Once the design is approved, we build your website using modern, responsive technologies. We ensure that it's optimized for speed, SEO, and a flawless user experience across all devices."
    }
  ];
    ...
    <section className="py-20 md:py-32 bg-black" id="process" ref={sectionRef}>
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row md:items-center mb-16">
          ...
          {/* Infinite slider with process types */}
        ...
        <div className="grid gap-12 md:gap-16 mx-auto">
            ...
            >
              <div className="md:col-span-3 flex items-center md:items-start">
                <div className="flex items-center">
                  {/* <motion.div 
                    className="text-[#4AFA4A] font-bold text-3xl mr-2"
